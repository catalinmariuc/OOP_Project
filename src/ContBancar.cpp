...
ContBancar::ContBancar(Client& this_Client, std::string tip, std::string valuta, unsigned long long int sold):Client(this_Client), tip(tip), valuta(valuta), sold(sold), ID_ContBancar(nextID_ContBancar++)
{
